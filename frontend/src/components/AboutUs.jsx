...
const  About= () => {
    return (  
        <div className="w-screen bg-gradient-custom m-0 h-[655px] relative">
            <div className=" text-white text-6xl font-playfair p-5 absolute left-80 top-1 font-bold">
                ABOUT US
            </div>
            <div>
            <div className="text-white font-titan text-4xl p-8 w-[900px] absolute top-[15vh]">
                ...
                <div className="text-white text-xl absolute bottom-[8vh] font-playfair p-10 flex justify-center items-center w-[900px]">
