...
const Testimonials = () => {
  ...
  return (
    <div className="w-screen h-[70vh] relative p-4 mt-10">
      <div className="h-full rounded-md flex flex-col antialiased bg-white dark:bg-black dark:bg-grid-white/[0.05] items-center justify-center relative overflow-hidden">
        ...
        <InfiniteMovingCards
          ...
          speed="normal"
        />
        <div className="absolute bottom-8 right-8 flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
